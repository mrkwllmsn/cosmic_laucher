...
if (NOT PICO_EXTRAS_PATH)
    message(WARNING "PICO EXTRAS location was not specified. Bluetooth support will be disabled.")
else()
    ...
    if (NOT EXISTS ${PICO_EXTRAS_PATH})
        message(WARNING "Directory '${PICO_EXTRAS_PATH}' not found. Bluetooth support will be disabled.")
