...
// BTstack features for HID Host support
...
// HID Host specific configuration
...
// Link Key DB using TLV on Flash
...
// HCI reset timeout for USB dongles (not needed for built-in, but doesn't hurt)
#define HCI_RESET_RESEND_TIMEOUT_MS 1000

// Enable software AES and ECC
#define ENABLE_SOFTWARE_AES128
#define ENABLE_MICRO_ECC_FOR_LE_SECURE_CONNECTIONS

// Enable enhanced retransmission for Classic
